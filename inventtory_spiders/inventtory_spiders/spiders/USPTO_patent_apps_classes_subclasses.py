...
class UsptoSpider(CrawlSpider):
    name = "uspto_app_classes_subclasses"
    ...
    def start_requests(self):
        ...
        codes = codes[:-4]  
        url = 'http://appft.uspto.gov/netacgi/nph-Parser?Sect1=PTO2&Sect2=HITOFF&u=%2Fnetahtml%2FPTO%2Fsearch-adv.html&r=0&p=1&f=S&l=50&Query=' + str(codes) + '&d=PG01'    
        #test
        print(url)
...
#scrapy crawl uspto_app_classes_subclasses -o uspto_app_classes_subclasses.csv
