...
class EspacenetSpider(CrawlSpider):
    ...
    def start_requests(self):
        ...
        ###you can enter multiple IPC numbers, in a list, i.e. ['A61K31/202','A61K31/232','A61M5/20','A41D23/00']###
        ipcs = ['A61K31/202', 'A61K9/107', 'A61K9/48']
        codes = ''
        for code in ipcs:
            codes = codes + '+' + str(code)
        #i.e. codes = 'A61K31/202+A61K9/107+A61K9/48'
        #example URL: https://worldwide.espacenet.com/data/searchResults?submitted=true&locale=en_EP&DB=EPODOC&ST=advanced&TI=&AB=&PN=&AP=&PR=&PD=&PA=&IN=&CPC=&IC=A61K31/202+A61K9/107+A61K9/48&Submit=Search
        url = 'https://worldwide.espacenet.com/data/searchResults?submitted=true&locale=en_EP&DB=EPODOC&ST=advanced&TI=&AB=&PN=&AP=&PR=&PD=&PA=&IN=&CPC=&IC=' + str(codes) + '&Submit=Search'
