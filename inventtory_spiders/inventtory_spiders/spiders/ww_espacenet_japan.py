'''
    File name: ww_espacenet_japan.py
...
class EuropeSpider(CrawlSpider):
    name = "espacenet_japan"
    def start_requests(self):
        #this URL brings up all the Japanese patents
        url = "https://worldwide.espacenet.com/data/searchResults?submitted=true&locale=en_EP&DB=EPODOC&ST=advanced&TI=&AB=&PN=JP&AP=&PR=&PD=&PA=&IN=&CPC=&IC=&Submit=Search"
