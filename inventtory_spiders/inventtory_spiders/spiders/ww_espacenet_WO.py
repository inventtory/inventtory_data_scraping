...
class EspacenetSpider(CrawlSpider):
    ...
    def start_requests(self):
        url = "https://worldwide.espacenet.com/data/searchResults?submitted=true&locale=en_EP&DB=EPODOC&ST=advanced&TI=&AB=&PN=WO&AP=&PR=&PD=&PA=&IN=&CPC=&IC=&Submit=Search"
...
#scrapy crawl espacenet_WO -o espacenet_WO_test3.csv
