'''
    File name: USPTO_patent_numbers.py
...
class UsptoSpider(CrawlSpider):
    name = "uspto_patent_numbers"
    #generate search urls
    def start_requests(self):
        #patent numbers must be 7 characters in length
        patent_nums = ['9503743', '9503693', '9503691']
        patents = ''
        #query for multiple patents needs to take this form: PN/9503743 OR PN/9503693 OR PN/9503691
        for patent in patent_nums:
            patents = patents + 'PN/' + str(patent) + ' OR '
        patents = patents[:-4]  
        url = 'http://patft.uspto.gov/netacgi/nph-Parser?Sect1=PTO2&Sect2=HITOFF&u=%2Fnetahtml%2FPTO%2Fsearch-adv.htm&r=0&p=1&f=S&l=50&Query=' + str(patents) + '&d=PTXT'
        #test
        print(url)
...
#scrapy crawl uspto_states -o one_hundred_thousand.csv
