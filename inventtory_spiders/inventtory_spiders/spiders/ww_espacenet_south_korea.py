...
class EuropeSpider(CrawlSpider):
    name = "espacenet_south_korea"
    def start_requests(self):
        url = "https://worldwide.espacenet.com/data/searchResults?submitted=true&locale=en_EP&DB=EPODOC&ST=advanced&TI=&AB=&PN=KR&AP=&PR=&PD=&PA=&IN=&CPC=&IC=&Submit=Search"
...
#print output to CSV
#scrapy crawl espacenet_south_korea -o espacenet_south_korea_test_2.csv
