...
class UsptoSpider(CrawlSpider):
    ...
    def start_requests(self):
        ...
        #or
        #2 IN/Lewis-Randall-J+OR+Sidebotham-Christopher-G+OR+Roitburg-Leon
        applicants = ''
        ...
        url = 'http://patft.uspto.gov/netacgi/nph-Parser?Sect1=PTO2&Sect2=HITOFF&u=%2Fnetahtml%2FPTO%2Fsearch-adv.htm&r=0&p=1&f=S&l=50&Query=' + str(applicants) + '&d=PTXT'
        #test
        print(url)
...
#scrapy crawl uspto_applicant -o uspto_applicant_test1.csv
