...
class EspacenetSpider(CrawlSpider):
    name = "espacenet_patent_num"
    def start_requests(self):
        
        #you can enter multiple patent numbers, in a list, i.e. ['US9486108','EP3089003','EP3085241']
        patent_numbers = ['US9486108','EP3089003','EP3085241']
        patents = ''
        for number in patent_numbers:
            patents = patents + '+' + str(number)
        url = 'https://worldwide.espacenet.com/data/searchResults?submitted=true&locale=en_EP&DB=EPODOC&ST=advanced&TI=&AB=&PN=' + str(patents) + '&AP=&PR=&PD=&PA=&IN=&CPC=&IC=&Submit=Search'
        yield Request(url, callback=self.parse_results, dont_filter=True)
