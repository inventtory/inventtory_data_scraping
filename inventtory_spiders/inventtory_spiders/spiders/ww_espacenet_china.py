'''
    File name: ww_espacenet_china.py
...
class EspacenetSpider(CrawlSpider):
    name = "espacenet_china"
    def start_requests(self):
        url = "https://worldwide.espacenet.com/data/searchResults?submitted=true&locale=en_EP&DB=EPODOC&ST=advanced&TI=&AB=&PN=CN&AP=&PR=&PD=&PA=&IN=&CPC=&IC=&Submit=Search"
...
#scrapy crawl espacenet_china -o espacenet_china_test1.csv
