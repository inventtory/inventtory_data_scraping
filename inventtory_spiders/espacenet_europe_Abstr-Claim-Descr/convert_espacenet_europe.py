...
save_path = 'C:\Users\serap\Desktop\inventtory_spider_respository_chris\inventtory_data_scraping\inventtory_data_scraping\inventtory_spiders\espacenet_europe_Abstr-Claim-Descr\TXT_espacenet_europe'

with open('CSV_espacenet_europe\espacenet_europe_1.csv', "rt") as f:
    reader = csv.reader(f)
