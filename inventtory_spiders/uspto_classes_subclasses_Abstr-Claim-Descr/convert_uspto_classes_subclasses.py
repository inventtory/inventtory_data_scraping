...
save_path = 'C:\Users\serap\Desktop\inventtory_spider_respository_chris\inventtory_data_scraping\inventtory_data_scraping\inventtory_spiders\uspto_classes_subclasses_Abstr-Claim-Descr\TXT_uspto_classes_subclasses'             

with open('CSV_uspto_classes_subclasses\uspto_classes_subclasses_2.csv', "rt") as f:
    reader = csv.reader(f)
